...
constexpr auto qt_meta_stringdata_CLASSRegisterFormENDCLASS = QtMocHelpers::stringData(
    "RegisterForm",
...
void RegisterForm::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (RegisterForm::*)(const QString & );
            if (_t _q_method = &RegisterForm::registrationSuccessful; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (RegisterForm::*)(const QString & );
            if (_t _q_method = &RegisterForm::loginSuccessful; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void RegisterForm::registrationSuccessful(const QString & _t1)
{
...
// SIGNAL 1
void RegisterForm::loginSuccessful(const QString & _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
